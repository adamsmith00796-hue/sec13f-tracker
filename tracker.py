...
<div style="max-width:720px;margin:0 auto;padding:24px 16px;">
  ...
  <!-- Footer -->
  <div style="background:#1e2a24;border:1px solid #2a4a3a;border-radius:8px;padding:16px;margin-bottom:16px;">
    <p style="margin:0 0 8px 0;font-weight:700;font-size:13px;color:#00d4aa;">What is the Buy Up To (&#8722;10%) price?</p>
    <p style="margin:0;font-size:12px;line-height:1.6;color:#e2e2e2;">The &#8220;Buy Up To (&#8722;10%)&#8221; column is the entry point price you should aim for. It means: &#8220;don&#8217;t chase it above this price &#8212; wait for it to pull back here before buying.&#8221; If the stock is already below it, it is currently a buy. If it is above it, set a price alert and wait.</p>
  </div>
